/**
 * RankResult — Central Exam Configuration
 *
...
export const EXAMS = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: 'The official RRB NTPC UG answer key is released on digialm.com. Copy your response sheet URL from there and paste it on RankResult to get instant score and rank.',
      },
      {
        q: 'How is RRB NTPC UG score calculated?',
        a: 'In RRB NTPC UG CBT, each correct answer gets +1 mark and each wrong answer gets -1/3 mark. Unattempted questions have no deduction. RankResult automatically applies this formula.',
      },
      {
      ...
      {
        q: 'How is rank calculated on RankResult?',
        a: 'RankResult calculates live rank based on scores of all candidates who checked results on this platform. This rank is unofficial and may differ from the official RRB result.',
      },
      {
        q: 'Can I download the RRB NTPC UG score card?',
        a: 'Yes! On RankResult you can download your score card in PNG and PDF format. It includes candidate photo, section-wise score, rank and percentile.',
      },
      {
        q: 'What is the expected cutoff for RRB NTPC UG 2025?',
        a: 'RRB NTPC UG expected cutoff varies by category and zone. Generally, for UR category, 60-70% marks fall within the expected cutoff range. You can understand your position with live rank on RankResult.',
      },
    ],
    seo: {
      title: 'RRB NTPC UG Answer Key 2025 — Score Calculator & Rank Predictor | RankResult',
      description:
      ...
      ogTitle: 'RRB NTPC UG Answer Key 2025 | Score Calculator & Rank | RankResult',
      ogDesc:
      ...
      twitterTitle: 'RRB NTPC UG Answer Key 2025 | RankResult',
    ...
    marketplace: {
      ...
      disclaimer: 'These question papers are reconstructed from memory by RRB NTPC UG candidates and are NOT official papers from Railway Recruitment Board. RankResult is not affiliated with RRB or Indian Railways. Use for practice purposes only.',
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: 'The official NTPC CBT-II answer key is published by the railway recruitment portal. Paste your response sheet URL on RankResult to get instant score, section-wise analysis and rank estimate.',
      },
      {
        q: 'How is NTPC CBT-II score calculated?',
        a: 'RankResult applies the exam marking scheme automatically so you can see your exact score with negative marking and unattempted questions accounted for.',
      },
      {
      ...
      {
        q: 'How is rank calculated on RankResult?',
        a: 'RankResult uses live candidate data to provide an unofficial rank estimate. This may differ from the official result announcement.',
      },
      {
      ...
      },
      {
        ...
        a: 'The expected cutoff depends on category, zone and vacancy pressure. RankResult helps you understand your standing with a live rank estimate and score analysis.',
      },
    ],
    seo: {
      title: 'NTPC CBT-II Rank Predictor 2025 — Score Calculator & Answer Key | RankResult',
      description:
      ...
      ogTitle: 'NTPC CBT-II Rank Predictor 2025 | Score Calculator & Answer Key | RankResult',
      ogDesc:
      ...
      twitterTitle: 'NTPC CBT-II Rank Predictor 2025 | RankResult',
    ...
    marketplace: {
      ...
      disclaimer: 'These question papers are reconstructed from memory by NTPC CBT-II candidates and are NOT official papers from Railway Recruitment Board. RankResult is not affiliated with RRB or Indian Railways. Use for practice purposes only.',
      defaultPackPrice: 499,       // Admin can override per pack from Admin Panel
      defaultPackCurrency: 'INR',
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: 'The official SSC CGL Tier-I answer key is released on ssc.nic.in. Paste your response sheet URL on RankResult to get instant score and rank.',
      },
      {
      ...
      {
        q: 'How is rank calculated on RankResult?',
        a: 'RankResult calculates live rank based on scores of all candidates who checked results on this platform. This rank is unofficial and may differ from the official SSC result.',
      },
      {
        q: 'What is the SSC CGL 2025 expected cutoff?',
        a: 'SSC CGL expected cutoff varies by category. For UR category, it usually ranges between 130-155 out of 200. You can understand your position with live rank on RankResult.',
      },
    ],
    seo: {
      title: 'SSC CGL Answer Key 2025 — Score Calculator & Rank Predictor | RankResult',
      description:
      ...
      ogTitle: 'SSC CGL Answer Key 2025 | Score Calculator & Rank | RankResult',
      ogDesc:
      ...
      twitterTitle: 'SSC CGL Answer Key 2025 | RankResult',
    ...
    marketplace: {
      ...
      disclaimer: 'These question papers are reconstructed from memory by candidates and are NOT official papers from Staff Selection Commission. RankResult is not affiliated with SSC. Use for practice purposes only.',
    ...
    faq: [
      {
        ...
        a: 'The official SSC CHSL Tier-I answer key is released on ssc.nic.in. Paste your response sheet URL on RankResult to get instant score and rank.',
      },
      {
      ...
      },
      {
        ...
        a: 'SSC CHSL cutoff varies by category and post. You can understand your standing with the live rank estimate on RankResult.',
      },
    ],
    seo: {
      title: 'SSC CHSL Answer Key 2025 — Score Calculator & Rank Predictor | RankResult',
      description:
      ...
      ogTitle: 'SSC CHSL Answer Key 2025 | Score Calculator & Rank | RankResult',
      ogDesc: 'Instantly check SSC CHSL Tier-I answer key, calculate exact score and predict your rank.',
      twitterTitle: 'SSC CHSL Answer Key 2025 | RankResult',
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: 'The official RRB ALP CBT-I answer key is released on digialm.com. Paste your response sheet URL on RankResult to get instant score and rank.',
      },
      {
    ...
    seo: {
      title: 'RRB ALP Answer Key 2025 — Score Calculator & Rank Predictor | RankResult',
      description:
      ...
      ogTitle: 'RRB ALP Answer Key 2025 | Score Calculator & Rank | RankResult',
      ogDesc: 'Instantly check RRB ALP CBT-I answer key, calculate exact score and predict your rank.',
      twitterTitle: 'RRB ALP Answer Key 2025 | RankResult',
    ...
    marketplace: {
      ...
      disclaimer: 'These question papers are reconstructed from memory by candidates and are NOT official papers from Railway Recruitment Board. RankResult is not affiliated with RRB. Use for practice purposes only.',
      defaultPackPrice: 499,
      defaultPackCurrency: 'INR',
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: 'The official RRB Group D CBT answer key is released on digialm.com. Paste your response sheet URL on RankResult to get instant score and rank.',
      },
      {
    ...
    seo: {
      title: 'RRB Group D Answer Key 2025 — Score Calculator & Rank Predictor | RankResult',
      description:
      ...
      ogTitle: 'RRB Group D Answer Key 2025 | Score Calculator & Rank | RankResult',
      ogDesc: 'Instantly check RRB Group D CBT answer key, calculate exact score and predict your rank.',
      twitterTitle: 'RRB Group D Answer Key 2025 | RankResult',
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: 'The official IBPS PO answer key is released on ibps.in. Paste your response sheet URL on RankResult to get instant score and rank.',
      },
      {
    ...
    seo: {
      title: 'IBPS PO Answer Key 2025 — Score Calculator & Rank Predictor | RankResult',
      description:
      ...
      ogTitle: 'IBPS PO Answer Key 2025 | Score Calculator & Rank | RankResult',
      ogDesc: 'Instantly check IBPS PO Prelims answer key, calculate exact score and predict your rank.',
      twitterTitle: 'IBPS PO Answer Key 2025 | RankResult',
    ...
    marketplace: {
      ...
      disclaimer: 'These question papers are reconstructed from memory by candidates and are NOT official papers from IBPS. RankResult is not affiliated with IBPS. Use for practice purposes only.',
      defaultPackPrice: 499,
      defaultPackCurrency: 'INR',
    },
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    faq: [
      {
        ...
        a: 'The official SSC MTS Tier-I answer key is released on ssc.nic.in. Paste your response sheet URL on RankResult to get instant score and rank.',
      },
      {
    ...
    seo: {
      title: 'SSC MTS Answer Key 2025 — Score Calculator & Rank Predictor | RankResult',
      description:
      ...
      ogTitle: 'SSC MTS Answer Key 2025 | Score Calculator & Rank | RankResult',
      ogDesc: 'Instantly check SSC MTS Tier-I answer key, calculate exact score and predict your rank.',
      twitterTitle: 'SSC MTS Answer Key 2025 | RankResult',
